          ...
          <div className="lg:flex row md:w-full pt-36">
            ...
            <div className="relative w-full max-w-md">
              <div>
                ...
                <div className="rounded-lg absolute border-dashed border-[6px] md:border-8 border-[#3482f679] dark:border-[#88b7fc7b] dark:hover:border-[#a0c6ff9f] h-72 w-72 top-[6.7rem] left-[6.2rem] md:h-82 md:w-82  md:top-[4rem] md:left-[13rem] lg:top-[16.5rem] lg:left-[10.1rem] hover:border-[#3482f6aa]"></div>
